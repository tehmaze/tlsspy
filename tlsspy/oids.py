...
OID_FRIENDLY = dict((OID(k), v) for k, v in (
    ...
    ('1.2.392.200011.61.1.1.1.1',        'misty1Cbc'),
    ('1.2.392.200091.100.721.1',         'Security Communication (SECOM) EV policy'),
    ('1.2.40.0.17.1.22',                 'ATrust EV policy'),
    ('1.2.410.200004.1',                 'kisaAlgorithm'),
    ('1.2.410.200004.1.1',               'kcdsa'),
    ('1.2.410.200004.1.10',              'pbeWithHAS160AndSEEDECB'),
    ('1.2.410.200004.1.11',              'pbeWithHAS160AndSEEDCBC'),
    ('1.2.410.200004.1.12',              'pbeWithHAS160AndSEEDCFB'),
    ('1.2.410.200004.1.13',              'pbeWithHAS160AndSEEDOFB'),
    ('1.2.410.200004.1.14',              'pbeWithSHA1AndSEEDECB'),
    ('1.2.410.200004.1.15',              'pbeWithSHA1AndSEEDCBC'),
    ('1.2.410.200004.1.16',              'pbeWithSHA1AndSEEDCFB'),
    ('1.2.410.200004.1.17',              'pbeWithSHA1AndSEEDOFB'),
    ...
    ('1.2.410.200046.1.1.1',             'aria128Ecb'),
    ('1.2.410.200046.1.1.10',            'aria192Ctr'),
    ('1.2.410.200046.1.1.11',            'aria256Ecb'),
    ('1.2.410.200046.1.1.12',            'aria256Cbc'),
    ('1.2.410.200046.1.1.13',            'aria256Cfb'),
    ('1.2.410.200046.1.1.14',            'aria256Ofb'),
    ('1.2.410.200046.1.1.15',            'aria256Ctr'),
    ('1.2.410.200046.1.1.2',             'aria128Cbc'),
    ('1.2.410.200046.1.1.21',            'aria128Cmac'),
    ('1.2.410.200046.1.1.22',            'aria192Cmac'),
    ('1.2.410.200046.1.1.23',            'aria256Cmac'),
    ('1.2.410.200046.1.1.3',             'aria128Cfb'),
    ('1.2.410.200046.1.1.31',            'aria128Ocb2'),
    ('1.2.410.200046.1.1.32',            'aria192Ocb2'),
    ('1.2.410.200046.1.1.33',            'aria256Ocb2'),
    ('1.2.410.200046.1.1.34',            'aria128Gcm'),
    ('1.2.410.200046.1.1.35',            'aria192Gcm'),
    ('1.2.410.200046.1.1.36',            'aria256Gcm'),
    ('1.2.410.200046.1.1.37',            'aria128Ccm'),
    ('1.2.410.200046.1.1.38',            'aria192Ccm'),
    ('1.2.410.200046.1.1.39',            'aria256Ccm'),
    ('1.2.410.200046.1.1.4',             'aria128Ofb'),
    ('1.2.410.200046.1.1.40',            'aria128Keywrap'),
    ('1.2.410.200046.1.1.41',            'aria192Keywrap'),
    ('1.2.410.200046.1.1.42',            'aria256Keywrap'),
    ('1.2.410.200046.1.1.43',            'aria128KeywrapWithPad'),
    ('1.2.410.200046.1.1.44',            'aria192KeywrapWithPad'),
    ('1.2.410.200046.1.1.45',            'aria256KeywrapWithPad'),
    ('1.2.410.200046.1.1.5',             'aria128Ctr'),
    ('1.2.410.200046.1.1.6',             'aria192Ecb'),
    ('1.2.410.200046.1.1.7',             'aria192Cbc'),
    ('1.2.410.200046.1.1.8',             'aria192Cfb'),
    ('1.2.410.200046.1.1.9',             'aria192Ofb'),
    ...
    ('1.2.752.34.1',                     'seisCp'),
    ('1.2.752.34.1.1',                   'SEIS highAssurance policyIdentifier'),
    ('1.2.752.34.1.2',                   'SEIS GAK policyIdentifier'),
    ('1.2.752.34.2',                     'SEIS pe'),
    ('1.2.752.34.3',                     'SEIS at'),
    ('1.2.752.34.3.1',                   'SEIS atPersonalIdentifier'),
    ('1.2.840.10040.1',                  'module'),
    ('1.2.840.10040.1.1',                'x9f1CertMgmt'),
    ...
    ('1.2.840.10040.3.2',                'attributeCert'),
    ('1.2.840.10040.4',                  'algorithm'),
    ('1.2.840.10040.4.1',                'dsa'),
    ('1.2.840.10040.4.2',                'dsaMatch'),
    ('1.2.840.10040.4.3',                'dsaWithSha1'),
    ('1.2.840.10045.1',                  'fieldType'),
    ('1.2.840.10045.1.1',                'primeField'),
    ('1.2.840.10045.1.2',                'characteristicTwoField'),
    ('1.2.840.10045.1.2.3',              'characteristicTwoBasis'),
    ...
    ('1.2.840.113533.7.65',              'nsnCe'),
    ('1.2.840.113533.7.65.0',            'entrustVersInfo'),
    ('1.2.840.113533.7.66',              'nsnAlg'),
    ...
    ('1.2.840.113533.7.67',              'nsnOc'),
    ('1.2.840.113533.7.67.0',            'entrustUser'),
    ('1.2.840.113533.7.68',              'nsnAt'),
    ...
    ('1.2.840.113549.1.1.8',             'pkcs1MGF'),
    ('1.2.840.113549.1.1.9',             'rsaOAEPPSpecified'),
    ('1.2.840.113549.1.12',              'pkcs12'),
    ('1.2.840.113549.1.12.1',            'pkcs12PbeIds'),
    ...
    ('1.2.840.113549.1.12.10',           'pkcs12Version1'),
    ('1.2.840.113549.1.12.10.1',         'pkcs12BadIds'),
    ('1.2.840.113549.1.12.10.1.1',       'pkcs12KeyBag'),
    ('1.2.840.113549.1.12.10.1.2',       'pkcs12Pkcs8ShroudedKeyBag'),
    ('1.2.840.113549.1.12.10.1.3',       'pkcs12CertBag'),
    ('1.2.840.113549.1.12.10.1.4',       'pkcs12CrlBag'),
    ('1.2.840.113549.1.12.10.1.5',       'pkcs12SecretBag'),
    ('1.2.840.113549.1.12.10.1.6',       'pkcs12SafeContentsBag'),
    ('1.2.840.113549.1.12.2',            'pkcs12ESPVKID'),
    ('1.2.840.113549.1.12.2.1',          'pkcs12PKCS8KeyShrouding'),
    ('1.2.840.113549.1.12.3',            'pkcs12BagIds'),
    ('1.2.840.113549.1.12.3.1',          'pkcs12KeyBagId'),
    ('1.2.840.113549.1.12.3.2',          'pkcs12CertAndCRLBagId'),
    ('1.2.840.113549.1.12.3.3',          'pkcs12SecretBagId'),
    ('1.2.840.113549.1.12.3.4',          'pkcs12SafeContentsId'),
    ('1.2.840.113549.1.12.3.5',          'pkcs12Pkcs8ShroudedKeyBagId'),
    ('1.2.840.113549.1.12.4',            'pkcs12CertBagID'),
    ('1.2.840.113549.1.12.4.1',          'pkcs12X509CertCRLBagID'),
    ('1.2.840.113549.1.12.4.2',          'pkcs12SDSICertBagID'),
    ('1.2.840.113549.1.12.5',            'pkcs12OID'),
    ('1.2.840.113549.1.12.5.1',          'pkcs12PBEID'),
    ('1.2.840.113549.1.12.5.1.1',        'pkcs12PBEWithSha1And128BitRC4'),
    ('1.2.840.113549.1.12.5.1.2',        'pkcs12PBEWithSha1And40BitRC4'),
    ('1.2.840.113549.1.12.5.1.3',        'pkcs12PBEWithSha1AndTripleDESCBC'),
    ('1.2.840.113549.1.12.5.1.4',        'pkcs12PBEWithSha1And128BitRC2CBC'),
    ('1.2.840.113549.1.12.5.1.5',        'pkcs12PBEWithSha1And40BitRC2CBC'),
    ('1.2.840.113549.1.12.5.1.6',        'pkcs12PBEWithSha1AndRC4'),
    ('1.2.840.113549.1.12.5.1.7',        'pkcs12PBEWithSha1AndRC2CBC'),
    ('1.2.840.113549.1.12.5.2',          'pkcs12EnvelopingID'),
    ('1.2.840.113549.1.12.5.2.1',        'pkcs12RSAEncryptionWith128BitRC4'),
    ('1.2.840.113549.1.12.5.2.2',        'pkcs12RSAEncryptionWith40BitRC4'),
    ('1.2.840.113549.1.12.5.2.3',        'pkcs12RSAEncryptionWithTripleDES'),
    ('1.2.840.113549.1.12.5.3',          'pkcs12SignatureID'),
    ('1.2.840.113549.1.12.5.3.1',        'pkcs12RSASignatureWithSHA1Digest'),
    ...
    ('1.2.840.113549.1.5.1',             'pbeWithMD2AndDESCBC'),
    ('1.2.840.113549.1.5.10',            'pbeWithSHAAndDESCBC'),
    ...
    ('1.2.840.113549.1.5.4',             'pbeWithMD2AndRC2CBC'),
    ('1.2.840.113549.1.5.6',             'pbeWithMD5AndRC2CBC'),
    ...
    ('1.2.840.113549.1.9.16',            'idSMIME'),
    ('1.2.840.113549.1.9.16.0',          'idMod'),
    ('1.2.840.113549.1.9.16.0.1',        'idModCms'),
    ('1.2.840.113549.1.9.16.0.2',        'idModEss'),
    ('1.2.840.113549.1.9.16.0.3',        'idModOid'),
    ('1.2.840.113549.1.9.16.0.4',        'idModMsgV3'),
    ('1.2.840.113549.1.9.16.0.5',        'idModEtsESignature88'),
    ('1.2.840.113549.1.9.16.0.6',        'idModEtsESignature97'),
    ('1.2.840.113549.1.9.16.0.7',        'idModEtsESigPolicy88'),
    ('1.2.840.113549.1.9.16.0.8',        'idModEtsESigPolicy88'),
    ...
    ('1.2.840.113549.1.9.16.4.1',        'certDistLdap'),
    ('1.2.840.113549.1.9.16.5.1',        'sigPolicyQualifierSpuri x'),
    ('1.2.840.113549.1.9.16.5.2',        'sigPolicyQualifierSpUserNotice'),
    ...
    ('1.2.840.113556.1.4.1429',          'msPKIRASignature'),
    ('1.2.840.113556.1.4.1430',          'msPKIEnrollmentFlag'),
    ('1.2.840.113556.1.4.1431',          'msPKIPrivateKeyFlag'),
    ('1.2.840.113556.1.4.1432',          'msPKICertificateNameFlag'),
    ('1.2.840.113556.1.4.1433',          'msPKIMinimalKeySize'),
    ('1.2.840.113556.1.4.1434',          'msPKITemplateSchemaVersion'),
    ('1.2.840.113556.1.4.1435',          'msPKITemplateMinorRevision'),
    ('1.2.840.113556.1.4.1436',          'msPKICertTemplateOID'),
    ('1.2.840.113556.1.4.1437',          'msPKISupersedeTemplates'),
    ('1.2.840.113556.1.4.1438',          'msPKIRAPolicies'),
    ('1.2.840.113556.1.4.1439',          'msPKICertificatePolicy'),
    ('1.2.840.113556.1.4.145',           'revision'),
    ('1.2.840.113556.1.4.1674',          'msPKICertificateApplicationPolicy'),
    ('1.2.840.113556.1.4.1675',          'msPKIRAApplicationPolicies'),
    ...
    ('1.3.14.3.2.3.1',                   'sqmodNwithRSA'),
    ('1.3.14.3.2.4',                     'md4WithRSAEncryption'),
    ('1.3.14.3.2.6',                     'desECB'),
    ('1.3.14.3.2.7',                     'desCBC'),
    ('1.3.14.3.2.8',                     'desOFB'),
    ('1.3.14.3.2.9',                     'desCFB'),
    ('1.3.14.3.3.1',                     'simpleStrongAuthMechanism'),
    ...
    ('1.3.36.3.4.1',                     'sigS_ISO97961'),
    ('1.3.36.3.4.2',                     'sigS_ISO97962'),
    ('1.3.36.3.4.2.1',                   'sigS_ISO97962Withred'),
    ('1.3.36.3.4.2.2',                   'sigS_ISO97962Withrsa'),
    ('1.3.36.3.4.2.3',                   'sigS_ISO97962Withrnd'),
    ('1.3.36.4',                         'attribute'),
    ('1.3.36.5',                         'policy'),
    ('1.3.36.6',                         'api'),
    ('1.3.36.6.1',                       'manufacturerSpecific_api'),
    ('1.3.36.6.1.1',                     'utimacoApi'),
    ('1.3.36.6.2',                       'functionalitySpecific_api'),
    ('1.3.36.7',                         'keymgmnt'),
    ('1.3.36.7.1',                       'keyagree'),
    ('1.3.36.7.1.1',                     'bsiPKE'),
    ('1.3.36.7.2',                       'keytrans'),
    ('1.3.36.7.2.1',                     'encISO97962Withrsa'),
    ...
    ('1.3.6.1.4.1.2712.10',              'ICETEL policyIdentifier'),
    ('1.3.6.1.4.1.2786.1.1.1',           'ICETEL Italian policyIdentifier'),
    ...
    ('1.3.6.1.4.1.3029.1.2.1.1',         'elgamalWithSHA1'),
    ('1.3.6.1.4.1.3029.1.2.1.2',         'elgamalWithRIPEMD160'),
    ...
    ('1.3.6.1.4.1.3029.42.11172.1',      'mpeg1'),
    ...
    ('1.3.6.1.4.1.40869.1.1.22.3',       'TWCA EV policy'),
    ...
    ('1.3.6.1.4.1.4788.2.202.1',         'DTRUST EV policy'),
    ...
    ('1.3.6.1.4.1.7879.13.24.1',         'TTeleSec EV policy'),
    ...
    ('1.3.6.1.5.5.7.11.1',               'pkixQCSyntaxV1'),
    ...
    ('1.3.6.1.5.5.7.6.3',                'dhSigHmacSha1'),
    ('1.3.6.1.5.5.7.6.4',                'dhPop'),
    ...
    ('2.16.578.1.26.1.3.3',              'BuyPass EV policy'),
    ...
    ('2.16.840.1.101.2.1.2.66',          'mspRev31ContentType'),
    ...
    ('2.16.840.1.101.2.1.3.10.11',       'siRELNZ'),
    ...
    ('2.16.840.1.101.2.1.3.10.7',        'siRELUS'),
    ('2.16.840.1.101.2.1.3.10.8',        'siRELAUS'),
    ('2.16.840.1.101.2.1.3.10.9',        'siRELCAN'),
    ...
    ('2.16.840.1.101.3.4.1.1',           'aes128ECB'),
    ('2.16.840.1.101.3.4.1.2',           'aes128CBC'),
    ('2.16.840.1.101.3.4.1.21',          'aes192ECB'),
    ('2.16.840.1.101.3.4.1.22',          'aes192CBC'),
    ('2.16.840.1.101.3.4.1.23',          'aes192OFB'),
    ('2.16.840.1.101.3.4.1.24',          'aes192CFB'),
    ('2.16.840.1.101.3.4.1.25',          'aes192Wrap'),
    ('2.16.840.1.101.3.4.1.26',          'aes192GCM'),
    ('2.16.840.1.101.3.4.1.27',          'aes192CCM'),
    ('2.16.840.1.101.3.4.1.28',          'aes192WrapPad'),
    ('2.16.840.1.101.3.4.1.3',           'aes128OFB'),
    ('2.16.840.1.101.3.4.1.4',           'aes128CFB'),
    ('2.16.840.1.101.3.4.1.41',          'aes256ECB'),
    ('2.16.840.1.101.3.4.1.42',          'aes256CBC'),
    ('2.16.840.1.101.3.4.1.43',          'aes256OFB'),
    ('2.16.840.1.101.3.4.1.44',          'aes256CFB'),
    ('2.16.840.1.101.3.4.1.45',          'aes256Wrap'),
    ('2.16.840.1.101.3.4.1.46',          'aes256GCM'),
    ('2.16.840.1.101.3.4.1.47',          'aes256CCM'),
    ('2.16.840.1.101.3.4.1.48',          'aes256WrapPad'),
    ('2.16.840.1.101.3.4.1.5',           'aes128Wrap'),
    ('2.16.840.1.101.3.4.1.6',           'aes128GCM'),
    ('2.16.840.1.101.3.4.1.7',           'aes128CCM'),
    ('2.16.840.1.101.3.4.1.8',           'aes128WrapPad'),
    ...
    ('2.16.840.1.113719.1.2.8.133',      'novellObfuscate1'),
    ...
    ('2.16.840.1.113719.1.2.8.51',       'ikeHmacWithSHA1RSA'),
    ('2.16.840.1.113719.1.2.8.52',       'ikeHmacWithMD5RSA'),
    ('2.16.840.1.113719.1.2.8.69',       'rc2CbcPad'),
    ('2.16.840.1.113719.1.2.8.82',       'sha1'),
    ...
    ('2.16.840.1.113730.1',              'certExtension'),
    ...
    ('2.16.840.1.113730.1.9',            'HomePageUrl'),
    ('2.16.840.1.113730.2',              'dataType'),
    ...
    ('2.16.840.1.114404.1.1.2.4.1',      'TrustWave EV policy'),
    ...
    ('2.16.840.1.114413.1.7.23.3',       'GoDaddy EV policy'),
